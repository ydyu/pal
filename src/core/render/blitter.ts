...
import { decodeRleFrame, getSpriteFrameBytes, type SpriteDirectory, type RleFrame } from "../codecs/rle.js";
...
export class Blitter {
  private frameCache: Map<string, RleFrame | null> = new Map();
   ...
   */
  public drawPixels(surface: Surface, frame: RleFrame, destX: number, destY: number): void {
