 ...
 */
export declare function isRectVisible(rect: Rect, viewport: Viewport): boolean;
/**
 ...
 */
export declare function getSpriteBounds(x: number, y: number, sLayer: number, frameWidth: number, frameHeight: number, sortOffsetY?: number, layerOffset?: number): SpriteBounds;
