import { ByteReader, readUint16LE } from "../binary.js";
/**
 ...
 */
export function wrapSingleFrameSprite(rleData) {
 ...
 */
export function parseSpriteDirectory(source) {
 ...
 */
export function getSpriteFrameBytes(directory, frameIndex) {
 ...
 */
export function decodeRleFrame(source) {
    if (source == null) {
        return null;
    }
